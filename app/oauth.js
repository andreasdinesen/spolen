'use strict';
/*
 * spolen - OAuth 2.1 til claude.ai's connectors.
 *
 ...
 *
 * Kopieret fra doda og tilpasset: spolen er FLERBRUGER, saa userId foelger
 * med gennem koden og ind i tokenet. Uden det ville en connector faa adgang
 * til den foerste bruger i tabellen.
 *
...
function opret(srv) {
  ...
  function registrer(krop) {
    ...
    const id = `spolen-client-${crypto.randomBytes(12).toString('hex')}`;
    srv.gemKlient({
      id,
